                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex w-full justify-center gap-4">
                      <button
                        ...
                        className="flex-1 py-2 px-4 cursor-pointer rounded-lg bg-gray-700 text-gray-200 font-medium hover:bg-gray-600 transition"
                      >
                        Cancel
                      </button>
                      ...
                      <button
                        ...
                        className="flex-1 py-2 px-4 cursor-pointer rounded-lg bg-red-800 text-white font-medium hover:bg-red-700 transition"
                      >
